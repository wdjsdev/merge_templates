...
function container()
{
	...
	function lockMaster()
	{
		...
		for(var a=0;a<masterLay.length;a++)
		{
			...
			{
				log.l(thisLay.name + " is likely a garment layer. Attempting to lock the information layer.")
				try
				{
				...
				log.l(thisLay.name + " is likely a garment layer. Attempting to hide the prepress layer.");
				try
				{
